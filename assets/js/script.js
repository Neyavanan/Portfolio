...
// testimonials variables (commented out since testimonials section was removed)
...
//     modalTitle.innerHTML = this.querySelector("[data-testimonials-avatar]").innerHTML;
...
for (let i = 0; i < navigationLinks.length; i++) {
  navigationLinks[i].addEventListener("click", function () {
    ...
    // Map navigation text to page data attributes
    const pageMap = {
      'about': 'about',
      'education': 'education',
